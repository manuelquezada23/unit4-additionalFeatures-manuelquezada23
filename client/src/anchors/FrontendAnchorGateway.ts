...
export const FrontendAnchorGateway = {
  ...
  deleteAnchor: async (anchorId: string): Promise<IServiceResponse<null>> => {
    try {
      return await remove<IServiceResponse<null>>(
  ...
  deleteAnchors: async (
    ...
    try {
      return await post<IServiceResponse<null>>(
  ...
  getAnchorsByNodeId: async (
    ...
    try {
      ...
      return failureServiceResponse(
        "[getAnchorsByNodeId] Unable to access backend"
      );
    }
  },
  ...
  updateExtent: async (
    ...
    try {
      ...
      return failureServiceResponse(
        "[updateAnchorExtent] Unable to access backend"
      );
    }
  },
};
