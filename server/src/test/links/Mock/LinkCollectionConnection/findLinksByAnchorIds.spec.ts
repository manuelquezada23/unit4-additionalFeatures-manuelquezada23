...
describe("Unit Test: findLinksByAnchorId", () => {
  ...
  let linkCollectionConnection: LinkCollectionConnection;
  ...
  test("gets links when given valid anchorIds", async () => {
    ...
    const createResponse1 = await linkCollectionConnection.insertLink(
      validLink1
    );
    ...
    const createResponse2 = await linkCollectionConnection.insertLink(
      validLink2
    );
    ...
    const createResponse3 = await linkCollectionConnection.insertLink(
      validLink3
    );
    ...
    const createResponse4 = await linkCollectionConnection.insertLink(
      validLink4
    );
  ...
  test("success with empty payload array when given invalid anchorIds", async () => {
    ...
    const findLinkByIdResp =
      await linkCollectionConnection.findLinksByAnchorIds(["anchor3"]);
